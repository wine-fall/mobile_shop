  ...
  <div> 
    <div class="goods"> 
      <div class="menu-wrapper" > 
        <ul> 
          <li class="menu-item " v-for="(good,index) in shopGoods" :key="index" :class="{current:index===currentIndex}" @click="goToFoods(index)"> 
        ...
        <ul ref="foodsWrapper"> 
          <li class="food-list-hook" v-for="(good,index) in shopGoods" :key="index" > 
            ...
            <ul v-for="(food,index) in good.foods" :key="index" @click="showFood(food)" > 
              <li class="food-item bottom-border-1px" v-if="good.foods"> 
                <div class="icon"> 
...
export default {
  ...
  methods:{
    _initScroll(){
        this.bsMenu=new BScroll('.menu-wrapper',{
          click:true
        })
        this.bsFood=new BScroll('.foods-wrapper',{
          probeType:2,
          click:true
        })
        this.bsFood.on('scroll',({x,y})=>{
          this.scrollY=Math.abs(y)
        })
        this.bsFood.on('scrollEnd',({x,y})=>{
          this.scrollY=Math.abs(y)
        })
    },
    _initTops(){
    ...
    goToFoods(index){
      ...
      this.bsFood.scrollTo(0,-scrollY,300)
    },
    showFood(food){
      this.food=food
