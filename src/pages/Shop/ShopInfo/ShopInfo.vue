  ...
  <div class="shop-info" >
    <div class="info-content" ref="infoContentRef">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="supportArray[support.type]" v-for="(support,index) in shopInfo.supports" :key="index">
...
export default {
  data(){
    return{
      supportArray:['activity-green','activity-red','activity-orange']
    }
  },
  computed:{
    ...mapState(['shopInfo'])
  ...
  methods:{
    _initScroll(){
      ...
      const ulPicList=this.$refs.picListRef
      ulPicList.style.width=this.shopInfo.pics.length*(ulPicList.children[0].clientWidth+6)-6+'px'
