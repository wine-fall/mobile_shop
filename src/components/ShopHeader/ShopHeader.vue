<template> 
  <div class="shop-header"> 
    ...
    <div class="shop-content" > 
      ...
      <div class="header-content"> 
        <h2 class="content-title"> 
          ...
          <i class="content-icon" @click="briefVisible=!briefVisible"></i> 
        </h2> 
        <div class="shop-message"> 
          <span class="shop-message-detail">{{shopInfo.foodScore}}</span> 
          <span class="shop-message-detail">月售 {{shopInfo.sellCount}} 单</span> 
          <span class="shop-message-detail">{{shopInfo.description}}<span style="margin-left:15px">约 {{shopInfo.deliveryTime}} 分钟</span></span> 
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports"> 
      ...
      <div class="discounts-right" @click="activityVisible=!activityVisible"> {{shopInfo.supports.length}} 个优惠 </div> 
    </div>
    <transition name="fade">
      <div class="shop-brief-modal" v-show="briefVisible"> 
        <div class="brief-modal-content" > 
          ...
          <ul class="brief-modal-msg"> 
            <li> <h3>3.5</h3> <p>评分</p></li> 
            <li> <h3>90 单</h3> <p>月售</p> </li> 
            <li> <h3>硅谷专送</h3> <p>约 28 分钟</p> </li> 
            <li> <h3>4 元</h3> <p>配送费用</p> </li> 
            <li> <h3>1000m</h3> <p>距离</p> </li> 
          </ul> 
          <h3 class="brief-modal-title"><span>公告</span></h3> 
          <div class="brief-modal-notice"> 是以粥为特色的中式营养快餐，自 2004 年 10 月 18 日创立“嘉和一品”品牌至今 </div> 
          <div class="mask-footer"> <i class="iconfont icon-icon-close" @click="briefVisible=false" style="color:white"></i> </div> 
        </div> 
        <div class="brief-modal-cover"></div> 
      </div>
    </transition>
    <transition name="fade">
      <div class="activity-sheet" v-show="activityVisible"> 
      <div class="activity-sheet-content"> 
        ...
        <div class="activity-sheet-close" @click="activityVisible=false"> 
